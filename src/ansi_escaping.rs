...
pub fn highlight(ctx: &egui::Context, text: &str) -> LayoutJob {
    ...
    ctx.memory().caches.cache::<HighlightCache>().get(text)
}
                ...
                if !ignore {
                    match action {
                        'm' => {
                            ...
                            let format =
                                if last_section.byte_range.end <= last_section.byte_range.start {
                            ...
                            while let Some(param) = params.next() {
                                match param[0] {
                                    ...
                                    47 => {
                                        format.background = egui::Color32::from_rgb(229, 229, 229)
                                    }
                                    49 => {
                                        format.background = egui::Color32::from_rgb(229, 229, 229)
                                    }
                                    ...
                                    100 => {
                                        format.background = egui::Color32::from_rgb(102, 102, 102)
                                    }
                                    101 => format.background = egui::Color32::from_rgb(241, 76, 76),
                                    102 => {
                                        format.background = egui::Color32::from_rgb(35, 209, 139)
                                    }
                                    103 => {
                                        format.background = egui::Color32::from_rgb(245, 245, 67)
                                    }
                                    104 => {
                                        format.background = egui::Color32::from_rgb(59, 142, 234)
                                    }
                                    105 => {
                                        format.background = egui::Color32::from_rgb(214, 112, 214)
                                    }
                                    106 => {
                                        format.background = egui::Color32::from_rgb(41, 184, 219)
                                    }
                                    107 => {
                                        format.background = egui::Color32::from_rgb(229, 229, 229)
                                    }
